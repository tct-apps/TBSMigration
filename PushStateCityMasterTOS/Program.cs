...
class Program
{
    ...
    static async Task State(string sourceConn)
    {
        ...
        try
        {
            ...
            string soapAction = soapActionBase + Constant.ApiUrlKey.StateInsert;
    ...
    static async Task City(string sourceConn)
    {
        ...
        try
        {
            string sqlPath = Path.Combine(Directory.GetCurrentDirectory(), "SQL", "City.sql");
            string sql = File.ReadAllText(sqlPath);
            ...
            Uri requestUrl = new Uri(url);
            string soapAction = soapActionBase + Constant.ApiUrlKey.CityInsert;
